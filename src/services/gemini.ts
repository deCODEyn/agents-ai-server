...
export async function generateAnswer(
  ...
  const prompt = `
    Com base no texto fonecido abaixo como contexto, responda a pergunta de forma clara e precisa em português do Brasil.
  ...
  if (!response.text) {
    throw new Error('Failed to generate response in Gemini model');
  }
